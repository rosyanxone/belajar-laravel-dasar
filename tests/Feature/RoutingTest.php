...
class RoutingTest extends TestCase
{
    public function testGet()
    {
        $this->get('/pzn')
            ->assertStatus(200)
            ->assertSeeText('Hello rosyanxone');
    }
    ...
    {
        $this->get('/tidakada')
            ->assertSeeText('404 by rosyanxone');
    ...
    public function testRouteParameterRegex()
    {
        ...
        $this->get('/categories/Rausyan')
            ->assertSeeText('404 by rosyanxone');
    }

    public function testRouteParameterOptional()
    {
        $this->get('/users/Rausyanfikr')
            ->assertSeeText('User Rausyanfikr');
    ...
    public function testRouteConflict()
    {
        ...
        $this->get('/conflict/Rausyanfikr')
            ->assertSeeText("Conflict Rausyanfikr");
    }
