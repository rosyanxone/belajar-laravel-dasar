...
Route::get('/pzn', function (){
    return "Hello rosyanxone";
});

Route::redirect('/youtube', '/pzn');

Route::fallback(function (){
    return "404 by rosyanxone";
});

Route::view('/hello', 'hello', ['name' => 'Rausyan']);

Route::get('/hello-again', function (){
    return view('hello', ['name' => 'Rausyan']);
});

Route::get('/hello-world', function (){
    return view('hello.world', ['name' => 'Rausyan']);
});
...
Route::get('/conflict/rausyan', function (){
    return "Conflict Rausyanfikr Adi Karmayoga";
});
